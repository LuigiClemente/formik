        ...
        >
          ...
          <Grid >
            <div className="col-lg-6">
              {" "}
              <input style={{ paddingTop: "8px", paddingBottom: "8px", minWidth: "100%", borderRadius: "5px", border: "2px solid #6c757d" }} type="date" value={values.departureDate} error={!!errors.departureDate}
